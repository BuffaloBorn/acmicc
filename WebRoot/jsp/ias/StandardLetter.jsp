		...
		<html:form action="/iuauser/stdLetterCreate" styleId="frmStdLetter">
			<forms:form formid="stdLetter" caption="form.iasdiary.std.letter.title" type="edit" width="750" noframe="false">
				<forms:section>
					...
					<forms:row>
						<forms:text label="form.iasdiary.std.letter.description" property="description" maxlength="60" size="60" colspan="1" onchange="gIasChangesWereMade=true"/>
						<forms:select id="attachmentid"	label="form.iasdiary.std.letter.attachment" property="attachment" size="1" onchange="gIasChangesWereMade=true">
					...
					<forms:row>					
						<forms:select id="statusid" label="form.iasdiary.std.letter.status" property="status" size="1" onchange="gIasChangesWereMade=true">
					...
					<forms:row>
						<forms:select id="second_requestid" label="form.iasdiary.std.letter.second.request" property="second_request" size="1" onchange="gIasChangesWereMade=true">
							<base:options property="secondRequestOptions" keyProperty="key" labelProperty="value" />
						</forms:select>
					</forms:row>
					<forms:row>
						<forms:textarea  id="letterTextArea" label="form.iasdiary.std.letter.letterTextArea" style="font-family: courier new" property="letterTextArea" cols="75" rows="14" maxlength="4500" valign="top" onkeydown="gIasChangesWereMade=true"/>		
					</forms:row>				
				</forms:section>
