			...
			<forms:form formid="eventPortamedic" caption="form.iasdiary.event.portamedic.title" type="edit" width="750" noframe="false">
				...
				<forms:section title="form.iasdiary.event.portamedic.phyician.section.title">
					...
					<forms:row>
						...
						<forms:select id="stateid" label="form.iasdiary.event.portamedic.state" property="phyician_state">
								<base:options property="statesOptions" keyProperty="key" labelProperty="value" />
						</forms:select>
						<forms:text label="form.iasdiary.event.portamedic.zip" property="phyician_zipCode" size="10" maxlength="10" colspan="1" onkeyup="javascript:return maskZipCode(this.value,this,'6','-');" onblur="javascript:return maskZipCode(this.value,this,'6','-');" onkeypress="if ((event.keyCode < 48) || (event.keyCode > 57)) event.returnValue = false;"/>
					</forms:row>
					<forms:row>
						<forms:text label="form.iasdiary.event.portamedic.phone" property="phyician_phone_number" size="12" maxlength="12" onkeyup="javascript:return mask(this.value,this,'3,7','-');" onblur="javascript:return mask(this.value,this,'3,7','-');" onkeypress="if ((event.keyCode < 48) || (event.keyCode > 57)) event.returnValue = false;"/>
						<forms:text label="form.iasdiary.event.portamedic.ext" property="phyician_phone_extentsion" size="4" maxlength="4" onkeypress="if ((event.keyCode < 48) || (event.keyCode > 57)) event.returnValue = false;"/>
						<forms:text label="form.iasdiary.event.portamedic.fax" property="phyician_fax_number" size="12" maxlength="12" onkeyup="javascript:return mask(this.value,this,'3,7','-');" onblur="javascript:return mask(this.value,this,'3,7','-');" onkeypress="if ((event.keyCode < 48) || (event.keyCode > 57)) event.returnValue = false;"/>
					</forms:row>
					<forms:row>
						<forms:plaintext label="form.iasdiary.event.portamedic.request.type" property="request_type"  colspan="1" />
					</forms:row>
					<forms:row>
						<pre><forms:textarea style="font-family: courier new"  label="form.iasdiary.event.portamedic.remarks" property="remarksTextArea" cols="60" rows="4" maxlength="300" valign="top" wrap="hard"/></pre>
					</forms:row>
			   	</forms:section>
		...
		<html:form action="/iuauser/eventPortamedic" styleId="frmEventPortamedic">
			<forms:form formid="eventPortamedic" caption="form.iasdiary.event.portamedic.title" type="edit" width="750" noframe="false">
				...
				<forms:section title="form.iasdiary.event.portamedic.phyician.section.title">
					...
					<forms:row>
						<forms:text label="form.iasdiary.event.portamedic.request.type" property="request_type"  size="10" maxlength="10"  colspan="1" />
					</forms:row>
					<forms:row>				 
						<pre><forms:textarea style="font-family: courier new" id="remarksTextArea"  label="form.iasdiary.event.portamedic.remarks" property="remarksTextArea" cols="60" rows="4" maxlength="300" valign="top" wrap="hard"/></pre>
					</forms:row>
				</forms:section>
