...
<%   DocumentMetaDataForm dmf1 = (DocumentMetaDataForm)session.getAttribute("myFormControl");
...
<html:form action="/main/appdocs/update">
	<forms:form type="edit" caption="form.doc.metadata.edit"
		formid="frmEdit" name="myFormControl" width="930" scope="session">
			...
			<forms:row>
				...
				<forms:select label="form.doc.State" property="state" 
					...
					<base:options property="statesList" keyProperty="key" 
						labelProperty="key" filter="false" />
				</forms:select>
