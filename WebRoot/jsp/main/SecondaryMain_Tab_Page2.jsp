...
<html:form action="/secondarymain/actpend">
	...
	<center>
		<forms:form width="50%" type="edit" name="activatePendingForm" formid="activatePendingForm">
...
Enter the policy number and click on the <b>Search</b> button. To Activate a pending process click on the check box then click the <b>Activate</b> button.
	...
	<c:if test="${processList != null}">
		...
		<center>
			<ctrl:list id="userlist1" action="/secondarymain/actpend" name="processList" title="actPend.title" noframe="false" noheader="false" width="75%" rows="10" refreshButton="false" select="multiple" formElement="false">
			...
			<table width="100%">
				<tr>
					<td class='legend' nowrap>
						<font color="Blue"> Standard&nbsp;Actions </font>
					</td>
				...
				<tr>
					<td colspan="2" align="left">
						<ctrl:button onclick="confirmActivate();" name="btnActivate" text="actPend.activate" />
					</td>
				</tr>
			</table>
