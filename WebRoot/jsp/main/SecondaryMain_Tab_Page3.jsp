...
<table width="100%" align="center">
	...
	<tr>
		...
		<td width="100%" align="center">
			<html:form action="/secondarymain/reassign">
...
<div align="center">
	<logic:present scope="session" name="ReassignTaskList">
		...
		<ctrl:list action="/secondarymain/reassign2" scope="session" name="ReassignTaskList" title="Reassign.list.title" rows="15" style="bgcolor:'#EFEFEF'" formElement="false" refreshButton="false" select="single">
