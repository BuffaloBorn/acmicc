 ...
 * @author usaho
 */
public class WorkListList implements ListDataModel {
	...
	public String getUniqueKey(int index) {
		long key = ((AcmiWorkItemBean) data[index]).getTaskId();
	...
	public void sortByColumn(String column, SortOrder direction) {
		WorkListColumnComparator workListColumnComparator = new WorkListColumnComparator(column, direction);
		Arrays.sort(data, workListColumnComparator);
	}
